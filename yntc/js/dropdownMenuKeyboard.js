...
$(".acilir").mouseover(function(){
	$(this).children("img").attr("src","../yntc/images/downArrow.png");
});
$(".acilir + ul").mouseover(function(){
	$(this).parent().children(".acilir").children("img").attr("src","../yntc/images/downArrow.png");
});
$(".acilir + ul").mouseout(function(){
	$(this).parent().children(".acilir").children("img").attr("src","../yntc/images/leftArrow.png");
});
$(".acilir").mouseout(function(){
	$(this).children("img").attr("src","../yntc/images/leftArrow.png");
});
